...
function setup(program) {
    program
        ...
        const pathToRuntimeConfig = path_1.default.resolve(constants_1.PATH_TO_RUNTIME, 'nginx.conf');
        createFileFromTemplate_1.default(constants_1.PATH_TO_TEMPLATE_NGINX_CONFIG, pathToRuntimeConfig);
        // create nginx config from template
        const pathToRuntimeDefault = path_1.default.resolve(constants_1.PATH_TO_RUNTIME, 'default.conf');
        ...
        const pathToRuntimePlaybook = path_1.default.resolve(constants_1.PATH_TO_RUNTIME, 'nginx.playbook.yml');
